...
#insert your email address in the field above you will then receive email notif$

#the scrtip below will run md5sum on all files ending in .sanfastq.gz in the di$
